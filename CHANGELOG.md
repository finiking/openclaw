...
- Secrets/web tools: resolve web tool SecretRefs at runtime with fail-fast handling for unresolved active refs, and keep last-known-good runtime snapshots on reload failures. (#41599) Thanks @joshavant.
